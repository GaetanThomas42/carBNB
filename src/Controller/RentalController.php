...
class RentalController
{
    ...
    public function myOwnerRents($userId)
    {
        //Récuperer les voitures
        $rentals = $this->rentalManager->selectByOwnerID($userId);
        //Afficher les voitures dans la template
        require_once("./templates/my_owner_rents.php");
    }
    ...
    public function rentForm(int $id, int $userLesseeId)
{
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        header("Location: index.php?action=my_rents");
